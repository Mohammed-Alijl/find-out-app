...
@section('title',__('admin/pages/customers.add.title'))
@section('page-header')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>{{__('admin/pages/customers.title')}}</strong> / {{__('admin/pages/customers.add.customer')}}
            </h3>
        </div>
    </div>
@endsection
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">{{__('admin/pages/customers.add.title')}}</h5>
                <h6 class="card-subtitle text-muted">{{__('admin/pages/customers.add.description')}}</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="inputPlatform" class="form-control" name="platform" required>
                                <option value="android" selected>{{__('admin/pages/customers.android')}}</option>
                                <option value="ios">{{__('admin/pages/customers.ios')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="inputZone" class="form-control choices-single" name="zone_id" required>
                                <option selected disabled value="">{{__('admin/pages/customers.choose')}}</option>
            ...
            Array.prototype.slice.call(forms)
                .forEach(function (form) {
                    form.addEventListener('submit', function (event) {
                        if (!form.checkValidity() || !validateEmail() || !validateMobile()) {
