...
@section('page-header')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>{{$parentCategory->name . " " . __('admin/pages/categories.category')}}</strong></h3>
        </div>
        <div class="col-auto ms-auto text-end mt-n1">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add">
                {{__('admin/pages/categories.add.nested.category')}}
            </button>
        </div>
    </div>
@endsection
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Type -->
                        <input type="hidden" name="category_type_id" value="{{$parentCategory->category_type_id}}">
                        <!-- Parent category -->
                        <input type="hidden" name="parent_category_id" value="{{$parentCategory->id}}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Parent category -->
                        <div class="mb-3">
                            <label class="form-label" for="parentCategoryInputEdit">{{__('admin/pages/categories.parent.category')}}
                                <span
                                    style="color: red">*</span></label>
                            <select id="parentCategoryInputEdit" class="form-control" name="parent_category_id" required>
                                @foreach($parentsCategories as $cat)
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#edit').on('show.bs.modal', function (event) {
                ...
                var parent_category_id = button.data('parent_category_id');
                var modal = $(this);
                ...
                // new Choices(document.querySelector('#parentCategoryInputEdit'));
                modal.find('.modal-body #parentCategoryInputEdit').val(parent_category_id);
            });
        });
