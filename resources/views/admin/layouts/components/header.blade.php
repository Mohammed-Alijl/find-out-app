                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                <div class="col-2">
                                    <img src="{{--{{URL::asset('img/users/' . auth('admin')->user()->image)}}--}}" class="avatar img-fluid rounded-circle" alt="Vanessa Tucker">
                                </div>
...
{{--            </li>--}}
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <img src="{{URL::asset('img/avatars/avatar.png')}}" class="avatar img-fluid rounded" alt="admin" />
                </a>
