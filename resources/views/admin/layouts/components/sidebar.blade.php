            ...
            <img src="https://hwdolive.hilwawater.sa/images/hilwa-water-logo.svg" alt="" height="80px" width="180px">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="categories" class="sidebar-dropdown list-unstyled collapse {{request()->route()->named(['types.index','categories.index','categories.show']) ? 'show' : ''}}" data-bs-parent="#sidebar">
                                ...
                                <li class="sidebar-item {{request()->route()->named(['categories.index','categories.show']) ? 'active' : ''}}"><a class="sidebar-link"
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="settings" class="sidebar-dropdown list-unstyled collapse {{request()->route()->named(['pages.index','pages.create','pages.edit','socials.index','contacts.index']) ? 'show' : ''}}" data-bs-parent="#sidebar">
                                ...
                                <li class="sidebar-item {{request()->route()->named(['contacts.index']) ? 'active' : ''}}"><a class="sidebar-link"
                                                            href="{{route('contacts.index')}}">{{__('admin/layouts/components/sidebar.messages')}}</a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
